...
#define kRefreshViewStartX 120
#define kRefreshViewHeight 30
...
- (instancetype)initInScrollView:(UIScrollView *)scrollView {
    self = [super initWithFrame:CGRectMake(0, kRefreshViewStartX, scrollView.frame.size.width, kRefreshViewHeight)];
    if (self) {
